...
function getArtistByIndex(array, index) {
    ind2Art = "The artist at index " + index + " is " + array[index].name
    return ind2Art
  }
...
console.log(addArtist(20, "Gerardo", "2001-present", "Web Design", "Hispanic", "Hello world! This is a filler sentence."))
...
//   let bigPaint = array.filter(function (e) {
//     return e.paintings >= 100
//   })
